...
export function setupSupabaseMock(options = {}) {
  ...
  vi.mock('../../lib/supabase', () => ({
    ...
    subscribeToChatPresence: vi.fn().mockReturnValue({ sendTyping: vi.fn(), unsubscribe: vi.fn() }),
    markMessagesRead: vi.fn().mockResolvedValue({ data: null, error: null }),
    countUnreadMessages: vi.fn().mockResolvedValue({ count: 0, error: null }),
