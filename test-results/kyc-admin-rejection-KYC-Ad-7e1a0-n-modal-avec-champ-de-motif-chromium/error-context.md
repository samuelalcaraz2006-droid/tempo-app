...
- Name: kyc-admin-rejection.spec.js >> KYC Admin — Rejet avec motif >> cliquer "Refuser" ouvre un modal avec champ de motif
- Location: e2e\kyc-admin-rejection.spec.js:36:7
